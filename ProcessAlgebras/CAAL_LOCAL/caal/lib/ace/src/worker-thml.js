...
define("ace/mode/ccs/thml_grammar",["require","exports","module"], function(require, exports, module) {
THMLParser = (function() {
...
(function (Traverse) {
    ...
    var ReducingSuccessorGenerator = (function () {
        ...
        ReducingSuccessorGenerator.prototype.reduceSuccessors = function (transitionSet) {
            ...
            var result = new ccs.TransitionSet();
            transitionSet.forEach(function (transition) {
                result.add(new ccs.Transition(transition.action, _this.reducer.visit(transition.targetProcess)));
            });
            return result;
        };
...
define("ace/mode/thml_worker",["require","exports","module","ace/lib/oop","ace/worker/mirror","ace/mode/ccs/thml_grammar","ace/mode/ccs/ccs","ace/mode/ccs/ccs","ace/mode/ccs/ccs"], function(require, exports, module) {
    "use strict";
    
    var oop = require("../lib/oop");
    var Mirror = require("../worker/mirror").Mirror;
    var HMLParser = require("./ccs/thml_grammar").THMLParser;
    var CCS = require("./ccs/ccs").CCS;
    var TCCS = require("./ccs/ccs").TCCS;
    var HML = require("./ccs/ccs").HML;

    var ThmlWorker = exports.ThmlWorker = function(sender) {
        Mirror.call(this, sender);
        this.setTimeout(1500);
    };
    oop.inherits(ThmlWorker, Mirror);
    ...
    function lint(value) {
        ...
        while (i < lines.length) {
            try {
                THMLParser.parse(value, {ccs: CCS, hml: HML, tccs: TCCS});
            } catch (err) {
                var temp = err.line;
